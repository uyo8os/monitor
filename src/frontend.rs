...
/// is not valid here, so it cannot be targeted. Deleting the currently selected
...
mod tests {
    ...
    fn an_uploaded_theme_is_checked_before_it_replaces_the_one_in_place() {
        ...
        // An optional preview.png is carried along; a theme without one, and a
        // name that is not a theme, both return nothing rather than erroring.
        install(
            &base,
    ...
    fn a_theme_name_is_checked_before_it_reaches_the_disk_or_the_settings_row() {
        ...
        // The built-in theme is served from the binary; a directory bearing its
        // name would displace it.
