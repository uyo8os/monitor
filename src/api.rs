...
async fn update(app: &App, short: &str) -> Result<(bool, String), anyhow::Error> {
    ...
    // constrained to the theme it may replace.
...
fn setting_error(app: &App, key: &str, value: &Value) -> Option<String> {
    ...
    match key {
        ...
        // stored, echoed back, and silently mean 30 days indefinitely.
...
mod tests {
    ...
    /// error downstream: it silently means 30 days, in a field still displaying
    /// what was entered.
    #[tokio::test]
